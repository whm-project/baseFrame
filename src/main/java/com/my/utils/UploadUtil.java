...
public class UploadUtil {
     ...
     * @return      上传结果
     */
    public static ResultViewModel uploadPicture(
        ...
        if(fileName!=null&&fileName!=""){
            ...
            try {
                ...
                //返回成功
                return new ResultViewModel(ResultViewModel.StateEnum.NORMAL.getValue(), "图片上传成功！", returnUrl+fileAdd+"/"+fileName);
            } catch (Exception e) {
                e.printStackTrace();
                //返回失败
                return new ResultViewModel(ResultViewModel.StateEnum.ABNORMAL.getValue(), "系统异常，图片上传失败！", null);
            }
        }
