...
public class SysDictvalue implements Serializable {
     ...
     * 排序值
     */
    @Column(name = "DICTVALUE_ORDER")
    private Integer dictvalueOrder;

    @Column(name = "DICTVALUE_OTHER1")
    private String dictvalueOther1;

    @Column(name = "DICTVALUE_OTHER2")
    private String dictvalueOther2;

    @Column(name = "DICTVALUE_OTHER3")
