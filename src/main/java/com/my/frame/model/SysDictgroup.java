...
public class SysDictgroup implements Serializable {
     ...
     * 排序值
     */
    @Column(name = "DICTGROUP_ORDER")
    private Integer dictgroupOrder;

    @Column(name = "DICTGROUP_OTHER1")
    private String dictgroupOther1;

    @Column(name = "DICTGROUP_OTHER2")
    private String dictgroupOther2;

    @Column(name = "DICTGROUP_OTHER3")
